...
public:
	...
	UPROPERTY(EditDefaultsOnly, Category = "Entropy Control")
	bool bTracksOwnRandomStream = true;

	// If true, ignore InitialSeed and randomize the seed for the random number stream
	UPROPERTY(EditDefaultsOnly, Category = "Entropy Control", meta = (EditCondition = "bTracksOwnRandomStream"))
	...
	UPROPERTY(EditDefaultsOnly, Category = "Entropy Control", meta = (EditCondition = "bTracksOwnRandomStream && !bShouldRandomizeSeed"))
	float InitialSeed = 0;
