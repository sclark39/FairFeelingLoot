...
class LTGENERICGRAPHEDITOR_API SEdNode_LTGenericGraphEdge : public SGraphNode
{
public:
	SLATE_BEGIN_ARGS(SEdNode_LTGenericGraphEdge){}
	SLATE_END_ARGS()

	void Construct(const FArguments& InArgs, UEdNode_LTGenericGraphEdge* InNode);
