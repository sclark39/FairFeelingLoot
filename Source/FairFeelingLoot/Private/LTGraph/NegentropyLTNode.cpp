...
const UGenericGraphNode* UNegentropyLTNode::PickChild(FLootTable &LootTable, const FEntropyState &State) const
{
...
#if WITH_EDITOR
TSubclassOf<UGenericGraphEdge> UNegentropyLTNode::GetEdgeType() const
{
