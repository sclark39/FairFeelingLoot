...
const UGenericGraphNode* URandomLTNode::PickChild(FLootTable &LootTable, const FEntropyState &State) const
{
	...
	if (*RequiresInitialization)
	{
		*RequiresInitialization = false;
		...
		{
			const UGenericGraphEdge *EdgeUncast = GetEdge(Node);
...
#if WITH_EDITOR
TSubclassOf<UGenericGraphEdge> URandomLTNode::GetEdgeType() const
{
