...
const UGenericGraphNode* ULTGraphNode::PickChild(FLootTable &LootTable, const FEntropyState &State) const
{
	// Follow first child
...
TSubclassOf<UGenericGraphEdge> ULTGraphNode::GetEdgeType() const
{
	return nullptr;
}
...
TSubclassOf<UGenericGraphEdge> URootLTGraphNode::GetEdgeType() const
{
	return nullptr;
}
...
{
	for (UGenericGraphNode *Node : RootNodes)
	{
